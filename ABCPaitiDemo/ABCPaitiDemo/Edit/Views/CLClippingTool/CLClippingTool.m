...
- (void)executeWithCompletionBlock:(void (^)(UIImage *, NSError *, NSDictionary *))completionBlock
{
    ...
    NSLog(@"executeWithCompletionBlock ivSize:%@ imgSize:%@", NSStringFromCGSize(self.editor.captureImageView.frame.size), NSStringFromCGSize(imageSize));
    ...
    NSLog(@"zoomScale:%f clipRect:%@", zoomScale, NSStringFromCGRect(_gridView.clippingRect));
    ...
    UIImage *result = [ABCImageUtil crop:self.editor.captureImageView.image rect:rct];
...
- (void)panGridView:(UIPanGestureRecognizer*)sender
{
    ...
    if ([sender.view isEqual:_ltView] || [sender.view isEqual:_rtView] || [sender.view isEqual:_lbView] || [sender.view isEqual:_rbView]) {
        NSLog(@"panGridView: touch corner");
    }
    else {
